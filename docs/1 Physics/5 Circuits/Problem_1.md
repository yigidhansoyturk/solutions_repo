...
<body>
  ...
  <section>
    ...
    <p>
      This tool allows you to construct and analyze electrical circuits using graph theory. Each node represents a junction and each edge represents a resistor with a specified resistance. Resistance is calculated using parallel combination rules between selected nodes.
    </p>
  </section>
