...
<body>
  <div class="container">
    ...
    <pre><code>F = G * M * m / r² = m * v² / r</code></pre>
    <p>Substituting the orbital velocity <code>v = 2πr / T</code> into the equation and solving for <code>T</code> gives:</p>
    <pre><code>T² = (4π² / GM) * r³</code></pre>
...
radii = np.linspace(6.4e6, 4.2e7, 100)  # from ~Earth surface to geosynchronous orbit
...
plt.show()</code></pre>
    ...
    <h2>Discussion</h2>
    <ul>
      <li><strong>Limitations:</strong> Assumes circular orbits and neglects perturbations, atmosphere drag, or relativistic effects</li>
