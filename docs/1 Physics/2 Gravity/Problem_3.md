...
<body>
  ...
  <section>
    <h2>Overview</h2>
    <p>
      When a payload is released near Earth from a moving object such as a rocket, its motion depends on its initial velocity and direction. This scenario encompasses fundamental laws of motion and gravitation, helping us study escape, reentry, or orbital trajectories.
    </p>
  </section>
